export const en = {
  ...
  channelManager: {
    ...
    redirectingToProvider: "Redirecting to provider...",
    oauthNotConfigured: "OAuth connector is not configured on the server yet.",
    linkedAccount: "Linked account",
    noLinkedAccountYet: "No linked account yet.",
    ...
    currency: "Currency",
    condition: "Condition",
    publishReadinessTitle: "eBay publish checklist",
    publishReadyNow: "This channel is connected and the current eBay listing prerequisites are filled in.",
    connectAccountFirst: "Connect the seller's eBay account first.",
    missingMerchantLocationKey: "Add merchant location key.",
    missingFulfillmentPolicyId: "Add fulfillment policy ID.",
    missingPaymentPolicyId: "Add payment policy ID.",
    missingReturnPolicyId: "Add return policy ID.",
    couldNotDisconnect: "Could not disconnect channel.",
    connectedChannel: (channelName: string) => `${channelName} connected successfully.`,
    disconnectedChannel: (channelName: string) => `${channelName} disconnected.`,
    oauthError: (code: string) => `Channel connection failed: ${code}.`
  },
  newProductPage: {
  ...
  productEditor: {
    ...
    overrideCategoryIdHint: "e.g. 57989",
    overrideCategoryIdHelp: "Use the numeric eBay category ID here. OmniList internal category IDs do not work for eBay publishing.",
