export const ru = {
  ...
  channelManager: {
    ...
    reconnectChannel: "Переподключить канал",
    disconnectChannel: "Отключить канал",
    redirectingToProvider: "Переадресация к провайдеру...",
    oauthNotConfigured: "OAuth-коннектор еще не настроен на сервере.",
    linkedAccount: "Подключенный аккаунт",
    noLinkedAccountYet: "Аккаунт еще не подключен.",
    connectedAt: "Подключено в",
    oauthBehaviorTitle: "Как работает подключение",
    oauthBehaviorDescription:
      "Если продавец уже вошел в eBay Sandbox, подключение может завершиться мгновенно без повторного экрана логина.",
    importSellerSetupTitle: "Импорт seller setup",
    importSellerSetupHint: "Загрузите merchant locations и business policies из подключенного eBay-аккаунта и выберите нужные ID прямо в OmniList.",
    importFromEbay: "Импортировать из eBay",
    loadingEbaySetup: "Загрузка seller setup...",
    loadedEbaySetup: "Настройки продавца eBay успешно импортированы.",
    couldNotLoadEbaySetup: "Не удалось загрузить seller setup из eBay.",
    ...
    currency: "Currency",
    condition: "Condition",
    publishReadinessTitle: "Чеклист eBay publish",
    publishReadyNow: "Канал подключен, и текущие prerequisites для eBay listing already filled in.",
    connectAccountFirst: "Сначала подключите eBay-аккаунт продавца.",
    missingMerchantLocationKey: "Добавьте merchant location key.",
    missingFulfillmentPolicyId: "Добавьте fulfillment policy ID.",
    missingPaymentPolicyId: "Добавьте payment policy ID.",
    missingReturnPolicyId: "Добавьте return policy ID.",
    couldNotDisconnect: "Не удалось отключить канал.",
    connectedChannel: (channelName: string) => `${channelName} успешно подключен.`,
    disconnectedChannel: (channelName: string) => `${channelName} отключен.`,
    oauthError: (code: string) => `Ошибка подключения канала: ${code}.`
  },
  newProductPage: {
    title: "Создать товар",
  ...
  productEditor: {
    ...
    overrideCategoryId: "eBay category ID",
    overrideCategoryIdHint: "например, 57989",
    overrideCategoryIdHelp: "Здесь нужен числовой ID категории eBay. Внутренние ID категорий OmniList для eBay не подходят.",
  ...
  publishCard: {
    ...
    enqueueSuccess: "Задача публикации успешно поставлена в очередь.",
