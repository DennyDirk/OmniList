export const uk = {
  ...
  productEditor: {
    ...
    overrideCategoryIdHint: "наприклад, 57989",
    overrideCategoryIdHelp: "Тут потрібен числовий ID категорії eBay. Внутрішні ID категорій OmniList для eBay не підходять.",
  ...
  publishCard: {
    ...
    enqueueSuccess: "Задачу публікації успішно поставлено у чергу.",
